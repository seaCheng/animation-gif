...
CFramelessWindowMain::CFramelessWindowMain(QWidget *parent)
    : AWMaskMainWindow(parent),
...
void CFramelessWindowMain::setResizeable(bool resizeable)
{
...
void CFramelessWindowMain::setResizeableAreaWidth(int width)
{
    if (1 > width) width = 1;
    m_borderWidth = width;
}

void CFramelessWindowMain::setTitleBar(QWidget* titlebar)
{
    m_titlebar = titlebar;
    if (!titlebar) return;
...
void CFramelessWindowMain::onTitleBarDestroyed()
{
...
void CFramelessWindowMain::addIgnoreWidget(QWidget* widget)
{
    if (!widget) return;
...
bool CFramelessWindowMain::nativeEvent(const QByteArray &eventType, void *message, long *result)
{
...
void CFramelessWindowMain::setContentsMargins(const QMargins &margins)
{
    QMainWindow::setContentsMargins(margins+m_frames);
    m_margins = margins;
}
void CFramelessWindowMain::setContentsMargins(int left, int top, int right, int bottom)
{
...
QMargins CFramelessWindowMain::contentsMargins() const
{
...
QRect CFramelessWindowMain::contentsRect() const
{
...
void CFramelessWindowMain::showFullScreen()
{
    if (isMaximized())
    {
        QMainWindow::setContentsMargins(m_margins);
