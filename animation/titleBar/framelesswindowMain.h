#ifndef hhh_CFRAMELESSWINDOWMAIN_hhh
#define hhh_CFRAMELESSWINDOWMAIN_hhh
...
#include <QMargins>
#include <QRect>
class CFramelessWindowMain : public QMainWindow
{
    Q_OBJECT
public:
    explicit CFramelessWindowMain(QWidget *parent = 0);
public:
