...
#include <memory>
#include "viewComponent/picScaleComp.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PicScaleComp_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PicScaleComp_t qt_meta_stringdata_PicScaleComp = {
    {
QT_MOC_LITERAL(0, 0, 12), // "PicScaleComp"
QT_MOC_LITERAL(1, 13, 9), // "s_clicked"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "PicScaleComp\0s_clicked\0"
};
...
void PicScaleComp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PicScaleComp::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PicScaleComp::s_clicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PicScaleComp::staticMetaObject = { {
    QMetaObject::SuperData::link<QFrame::staticMetaObject>(),
    qt_meta_stringdata_PicScaleComp.data,
