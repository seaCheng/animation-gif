...
#include <memory>
#include "../../../qt-mvvm/source/libmvvm_viewmodel/mvvm/editors/coloreditor.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ModelView__ColorEditor_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_ModelView__ColorEditor_t qt_meta_stringdata_ModelView__ColorEditor = {
    {
        QT_MOC_LITERAL(0, 22)   // "ModelView::ColorEditor"
    },
...
const QMetaObject ModelView::ColorEditor::staticMetaObject = { {
    QMetaObject::SuperData::link<CustomEditor::staticMetaObject>(),
    qt_meta_stringdata_ModelView__ColorEditor.offsetsAndSizes,
    qt_meta_data_ModelView__ColorEditor,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ModelView__ColorEditor_t
, QtPrivate::TypeAndForceComplete<ColorEditor, std::true_type>
