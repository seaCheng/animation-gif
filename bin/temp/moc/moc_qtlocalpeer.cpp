...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QtLocalPeer_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_QtLocalPeer_t qt_meta_stringdata_QtLocalPeer = {
    {
        QT_MOC_LITERAL(0, 11),  // "QtLocalPeer"
        QT_MOC_LITERAL(12, 15),  // "messageReceived"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 7),  // "message"
        QT_MOC_LITERAL(37, 17)   // "receiveConnection"
    },
    "QtLocalPeer",
    "messageReceived",
    "",
...
const QMetaObject QtLocalPeer::staticMetaObject = { {
    ...
    qt_meta_stringdata_QtLocalPeer.offsetsAndSizes,
    qt_meta_data_QtLocalPeer,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QtLocalPeer_t
, QtPrivate::TypeAndForceComplete<QtLocalPeer, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<const QString &, std::false_type>
