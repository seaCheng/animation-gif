...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_DPI_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_DPI_t qt_meta_stringdata_DPI = {
    {
        QT_MOC_LITERAL(0, 3)   // "DPI"
    },
    "DPI"
};
...
const QMetaObject DPI::staticMetaObject = { {
    ...
    qt_meta_stringdata_DPI.offsetsAndSizes,
    qt_meta_data_DPI,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_DPI_t
, QtPrivate::TypeAndForceComplete<DPI, std::true_type>
